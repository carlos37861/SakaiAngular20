    ...
    template: ` <div class="layout-topbar">
        <div class="layout-topbar-logo-container">
            ...
            <a class="layout-topbar-logo" routerLink="/">
                ...
                width="60pt" height="60pt" viewBox="0 0 1190.000000 1280.000000"
...
<div class="relative">
    ...
    <!-- MENÚ DE USUARIO -->
    <div
        class="absolute right-0 mt-2 w-64 bg-surface-0 dark:bg-surface-800 shadow-xl rounded-lg hidden z-50"
    >
        <!-- Cabecera con foto + datos -->
        <div class="flex items-center gap-3 p-4 border-b border-gray-200 dark:border-gray-700">
            
            <!-- Foto redonda -->
            <img
                src="https://ui-avatars.com/api/?name=Carlos+Perez&background=0D8ABC&color=fff&size=128"
                class="w-12 h-12 rounded-full shadow-md"
            />

            <!-- Datos del usuario -->
            <div>
                <div class="text-gray-900 dark:text-gray-100 font-semibold text-base">
                    {{ username }}
                </div>
        ...
        <div class="flex flex-col py-2">
            <button
                class="px-4 py-2 text-left text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700"
                (click)="goToProfile()"
            >
                <i class="pi pi-cog mr-2"></i> Mi Perfil
            </button>

            <button
                class="px-4 py-2 text-left text-red-600 hover:bg-red-100 dark:hover:bg-red-900"
                (click)="logout()"
            >
...
userCompany = 'Taruma Mining Corp';
...
logout() {
    alert('Cerrar sesión')
    // Aquí limpias el token, sesión, etc.
